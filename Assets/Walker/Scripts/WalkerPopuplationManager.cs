...
public class WalkerPopuplationManager : MonoBehaviour
{
    ...
    void Start()
    {
        for (var i = 0; i < PopulationSize; i++)
        {
            ...
            instanceGO.GetComponent<WalkerBrain>().Init();
    ...
    private GameObject Breed(GameObject parent1, GameObject parent2)
    {
        ...
        {
            brain.Dna.Combine(
                parent1.GetComponent<WalkerBrain>().Dna,
                parent2.GetComponent<WalkerBrain>().Dna
            );
        }
    ...
    private void BreedNewPopulation()
    {
        var sortedList = population
                        .OrderBy(x => x.GetComponent<WalkerBrain>().DistanceTraveled)
                        .ToList();
        population.Clear();
